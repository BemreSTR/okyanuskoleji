...
<div align="center">
  ...
  [🌐 Canlı Demo](https://dinakademi.com) | [📖 Dokümantasyon](#özellikler) | [🐛 Sorun Bildir](https://github.com/BemreSTR/Dinakademi/issues)
</div>
...
1. **Repository'yi klonlayın:**
   ```bash
   git clone https://github.com/BemreSTR/Dinakademi.git
   cd Dinakademi
   ```
